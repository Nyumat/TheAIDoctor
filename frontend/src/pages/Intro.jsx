      ...
      <section className="h-screen">
        <div className="px-6 h-full text-gray-800">
          <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            <img
              src={doctors}
              className="bottom-10 left-[-5rem] absolute w-1/2 h-1/2 scale-75 pl-16 z-50"
              alt="Sample image"
            />

            <div className="absolute flex flex-col items-center justify-center w-max h-screen left-0 scale-50 pb-32 mr-64 translate-x-[-4rem]">
              <img
            ...
            <img
              src={medicine}
              className="bottom-0 right-0 absolute w-1/2 h-3/4 scale-75 pl-16"
              alt="Sample image"
            />
